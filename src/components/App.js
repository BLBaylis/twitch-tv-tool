...
class App extends React.Component {
	constructor(props) {
		...
		this.state = {
			streams : {
				brad: ["foggedftw2", "boxerpete", "neace", "grossie_gore", "loltyler1", "tobiasfate", "karnrs", "hashinshin", "IWillDominate"],
  	...
  	render() {
    	return (
      		<div className="app">
        		...
        		<StreamerSearch/>
        		<RefreshBtn refresh = {this.dataThrottle} refreshSpin = {this.state.refreshSpin}/>
